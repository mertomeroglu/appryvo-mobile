...
export const DiscoverScreen: React.FC = () => {
  ...
  const resolveDiscoverLocation = useCallback(async (
    ...
    try {
      ...
      try {
        // Deliberately no mapVisible field: location is optional, used for informational
        // distance labels only, and must never flip the user's map visibility either way (see
