...
export const communityRoomsService = {
  ...
  create: async (body:{title:string;topic:string;category:RoomCategory;language:string;cityId:number;maxParticipants:number;idempotencyKey:string}) => data<CommunityRoom>(await apiClient.post('/api/rooms',body)),
