...
export const VerificationScreen: React.FC = () => {
  ...
  return <div className="flex flex-col h-full w-full bg-app text-app select-none">
    {phase !== 'camera' && <header className="pt-safe px-4 h-16 flex items-center gap-3 border-b border-app bg-surface-80"><IconButton aria-label={t('backButtonLabel')} variant="ghost" size="sm" onClick={() => navigate(-1)}><ArrowLeft /></IconButton><AppLogo variant="icon" size="sm" /><h2 className="text-heading">{t('verificationScreenTitle')}</h2></header>}
